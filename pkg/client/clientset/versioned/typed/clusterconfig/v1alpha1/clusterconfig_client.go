...
import (
	...
	"github.com/myoperator/clusterconfigoperator/pkg/client/clientset/versioned/scheme"
...
func (c *ApiV1alpha1Client) ClusterConfigs(namespace string) ClusterConfigInterface {
